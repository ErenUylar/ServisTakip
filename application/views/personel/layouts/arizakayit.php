                                        ...
                                        <?php } else{ ?>
                                            ...
                                            <?php foreach ($veri as $item) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="width: 400px"><a class="btn btn-primary btn-rounded btn-fw" href="<?php echo base_url("personel/arizadetay/$item->ip_adresi/")?>">Tüm Kayıtlar</a></td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                                        <?php } ?>
