            ...
            <div class="content-wrapper">
                <div class="row ">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Personel Görüntüle</h2>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="color: white">
                                        <?php if (empty($model)) { ?>
                                            <h1 class="card-title" style="text-align: center">KAYITLI PERSONEL YOK!</h1>
                                        <?php } else{ ?>
                                            <thead>
                                                <tr>
                                                    <th>İsim</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($veri as $item) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center" style="width: 300px"><a class="btn btn-danger btn-rounded btn-fw" href="<?php echo base_url("admin/personelsil/$item->id/")?>" >Personel Sil</a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        <?php } ?>
